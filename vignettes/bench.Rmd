---
title: "JSON Parsing Performance Benchmark: structr vs jsonlite vs rjson vs RJSONIO"
output:
  html_document:
    toc: yes
    toc_float: yes
...
required_pkgs <- c("structr", "jsonlite", "rjson", "RJSONIO", "microbenchmark", "ggplot2", "dplyr")
